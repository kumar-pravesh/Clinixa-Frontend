...
const BillingManagement = () => {
    ...
    const stats = [
        { label: 'Total Billed', value: `$${totalBilled}`, icon: '≡ƒÆ│', color: 'bg-blue-100' },
        { label: 'Total Paid', value: `$${totalPaid}`, icon: 'Γ£ô', color: 'bg-green-100' },
        { label: 'Unpaid Bills', value: `${unpaidCount}`, icon: 'ΓÅ│', color: 'bg-yellow-100' },
    ];
