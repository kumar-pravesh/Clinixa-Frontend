...
import { Lock, ArrowLeft, ArrowRight, AlertCircle, Loader2, CheckCircle2, ShieldCheck } from 'lucide-react';
        ...
        <div className="min-h-screen flex bg-white font-sans overflow-hidden">
                ...
                >
                    ...
                    <div className="space-y-3 mb-10">
                        <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10 w-fit">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-emerald-400">Secure Reset</span>
                        </div>
                    ...
                    <p className="text-xl text-slate-400 max-w-lg leading-relaxed font-medium mb-12">
                        Set a new secure password for your institutional access.
                    </p>
                </MotionDiv>
            ...
            <div className="w-full lg:w-[45%] flex items-center justify-center p-8 lg:p-24 bg-white relative">
                ...
                >
                    ...
                    <div className="mb-14">
                        <h2 className="text-5xl font-black text-slate-950 tracking-tighter leading-none mb-6">Set New<br />Password.</h2>
                        <div className="flex items-center gap-3">
                            <ShieldCheck size={18} className="text-primary" />
                            <span className="text-slate-400 font-black uppercase text-[10px] tracking-[0.4em]">Encrypted Reset Channel</span>
                        </div>
                    </div>
                    ...
                    {!success ? (
                        <form onSubmit={handleSubmit} className="space-y-10" noValidate>
                            <div className="space-y-6">
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-4 ml-2">New Credentials</p>
                                <div className="space-y-4">
                                    <div className="group relative">
                                        <Lock className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors text-slate-400 group-focus-within:text-primary" />
                                        <input
                                            type="password"
                                            value={newPassword}
                            ...
                            >
                                {loading ? (
                                    ...
                                    <>
                                        Reset Password <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform" />
                                    </>
                                )}
                            </button>
                        </form>
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <h3 className="text-2xl font-black text-slate-950 tracking-tight">Password Reset Successful</h3>
