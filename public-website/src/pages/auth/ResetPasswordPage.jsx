            ...
            <div className="hidden lg:flex w-[55%] bg-slate-950 text-white p-20 flex-col justify-between relative overflow-hidden">
                ...
                >
                    ...
                    <p className="text-xl text-slate-400 max-w-lg leading-relaxed font-medium mb-12">
                        Set a new secure password for your clinical account.
                    </p>
                </MotionDiv>
                ...
                >
                    ...
                    <div className="mb-14">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-400 font-black uppercase text-[10px] tracking-[0.4em]">Encrypted Reset</span>
                        </div>
                    </div>
                    ...
                    {!success ? (
                        <form onSubmit={handleSubmit} className="space-y-10" noValidate>
                            <div className="space-y-6">
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-4 ml-2">New Password</p>
