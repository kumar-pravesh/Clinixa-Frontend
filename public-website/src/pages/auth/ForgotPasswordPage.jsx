            ...
            <div className="hidden lg:flex w-[55%] bg-slate-950 text-white p-20 flex-col justify-between relative overflow-hidden">
                ...
                >
                    ...
                    <p className="text-xl text-slate-400 max-w-lg leading-relaxed font-medium mb-12">
                        Securely reset your credentials through our encrypted recovery system.
                    </p>
                </MotionDiv>
                ...
                >
                    ...
                    <div className="mb-14">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-400 font-black uppercase text-[10px] tracking-[0.4em]">Secure Recovery</span>
                        </div>
                    </div>
